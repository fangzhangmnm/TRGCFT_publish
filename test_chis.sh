...
do
    ...
    python run_get_ltrg_eigvecs.py --filename data/hotrg_gilt_chis/X${MAX_DIM}/lTRG_gilt_L30.pth --tensor_path data/hotrg_gilt_chis/X${MAX_DIM}/tensor.pth --iLayer 30 --mcf_enabled --gilt_enabled  --svd_num_eigvecs 32
done
